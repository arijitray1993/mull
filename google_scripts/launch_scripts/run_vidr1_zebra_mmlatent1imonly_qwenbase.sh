...
# bash google_scripts/launch_scripts/run_vidr1_zebra_mmlatent1imonly_qwenbase.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_zebra_mmlatent1imonly_qwenbase.yaml"
