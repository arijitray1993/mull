...
# bash google_scripts/launch_scripts/run_sft_qwen_vidr1_SAT_zebra_mmlatent_stage2.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_sft_mmlatent2.yaml"
