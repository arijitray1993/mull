...
# bash google_scripts/launch_scripts/run_sft_qwenlatent1cont_vidr1_SAT_zebra_mmlatent_stage3.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_sft_mmlatent3_qwenlatent1cont.yaml"
