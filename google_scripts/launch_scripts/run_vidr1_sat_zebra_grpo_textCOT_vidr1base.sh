...
# bash google_scripts/launch_scripts/run_vidr1_sat_zebra_grpo_textCOT_vidr1base.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_grpo_textCOT_vidr1base.yaml"
