...
# bash google_scripts/launch_scripts/run_grponoref_mmlatent2_mmlatent2wtxt.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_grponoref_mmlatent2_qwenlatent2wtxt.yaml"
