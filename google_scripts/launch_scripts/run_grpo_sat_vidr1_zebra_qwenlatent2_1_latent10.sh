...
# bash google_scripts/launch_scripts/run_grpo_sat_vidr1_zebra_qwenlatent2_1_latent10.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_grpo_mmlatent2_qwenlatent1_new10.yaml"
