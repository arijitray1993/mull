...
# bash google_scripts/launch_scripts/run_basicreinforce_sims_sat_vidr1_zebra_qwenlatent2_1.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_sims_zebra_basicreinforce_mmlatent2_qwenlatent1.yaml"
