...
# bash google_scripts/launch_scripts/run_sat_vidr1cot_zebraans_sft_sepprompt.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/sat_vidr1cot_zebraans_sft_sepprompt.yaml"
