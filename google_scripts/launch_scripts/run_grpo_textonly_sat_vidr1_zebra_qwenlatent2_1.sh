...
# bash google_scripts/launch_scripts/run_grpo_textonly_sat_vidr1_zebra_qwenlatent2_1.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_grpo_mmlatent2_qwenlatent1_new_textonly.yaml"
