...
# bash google_scripts/launch_scripts/run_grponoref_mmlatent2_1.sh
...
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_grponoref_mmlatent2_qwenlatent1.yaml"
