...
# bash google_scripts/launch_scripts/run_grpo_sat_vidr1_zebra_qwenlatent2discrete_1_40.sh
...
python3 google_scripts/google_prep_scripts/grab_checkpoints_bash.py vidr1_sat_zebra_sft_mmlatent2discrete_qwenlatent1/2025-10-30_03-04-36/checkpoint-24000

# set the exp config file
EXP_CONFIG_FILE="../../google_scripts/exp_configs/vidr1_sat_zebra_grpo_mmlatent2discrete_qwenlatent1_40lat.yaml"
